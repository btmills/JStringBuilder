...
(function(exports) {
  return exports.StringBuilder = (function() {
    ...
    */
    ...
    function _Class(str) {
      this.substring = __bind(this.substring, this);
    ...
    */
    ...
    _Class.prototype.remove = function(start, end) {
      if (end === void 0 && (-this.chars.length <= start && start < this.chars.length)) {
    ...
    _Class.prototype.substring = function(start, end) {
      ...
      if ((0 <= start && start < end)) {
        return new exports.StringBuilder(this.chars.slice(start, end).join(''));
      } else {
